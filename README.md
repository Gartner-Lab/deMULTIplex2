...
Because of its mechanism-guided design, **deMULTIplex2** can be applied to datasets generated from technologies that label cells or nuclei with a sample specific tag (e.g., DNA oligonucleotides) for pooled processing, including but not limited to: <br>
